...
class DiscountTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount_type" do
    assert_difference('DiscountType.count') do
      post discount_types_url, params: { discount_type: { name: @discount_type.name, status: @discount_type.status } }
    end
  ...
  test "should update discount_type" do
    patch discount_type_url(@discount_type), params: { discount_type: { name: @discount_type.name, status: @discount_type.status } }
