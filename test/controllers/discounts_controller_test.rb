...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { discount_type: @discount.discount_type, rate: @discount.rate, status: @discount.status } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { discount_type: @discount.discount_type, rate: @discount.rate, status: @discount.status } }
