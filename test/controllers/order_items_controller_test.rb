...
class OrderItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_item" do
    assert_difference('OrderItem.count') do
      post order_items_url, params: { order_item: { store_item_id: @order_item.store_item_id, user_id: @order_item.user_id } }
    end
  ...
  test "should update order_item" do
    patch order_item_url(@order_item), params: { order_item: { store_item_id: @order_item.store_item_id, user_id: @order_item.user_id } }
