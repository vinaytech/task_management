...
class TaxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tax" do
    assert_difference('Tax.count') do
      post taxes_url, params: { tax: { rate: @tax.rate, status: @tax.status, tax_type: @tax.tax_type } }
    end
  ...
  test "should update tax" do
    patch tax_url(@tax), params: { tax: { rate: @tax.rate, status: @tax.status, tax_type: @tax.tax_type } }
